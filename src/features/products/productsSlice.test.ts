...
describe('products reducer', () => {
  ...
  it('should not allow the same product to be added more than once', () => {
    ...
    // we'll say at the end here result = products reducer result, action.
    //  We're going to rerun the products reducer with the output of the last run of products reducer
    /// and then save that output to result.
